...
-- Allow app roles to call (for Community tab)
GRANT EXECUTE ON FUNCTION get_global_leaderboard(int) TO authenticated;
GRANT EXECUTE ON FUNCTION get_global_leaderboard(int) TO anon;
GRANT EXECUTE ON FUNCTION get_challenge_share_leaderboard(int) TO authenticated;
GRANT EXECUTE ON FUNCTION get_challenge_share_leaderboard(int) TO anon;
