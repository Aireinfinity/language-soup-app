-- Migration: Harden Identity Claim (Prevent 'Anonymous' Overwrites)
-- Description: Updates claim_user_identity RPC to conditionally update display_name.
--              It will NOT overwrite an existing name with 'Anonymous'.
...
BEGIN
  ...
  ON CONFLICT (id) DO UPDATE SET
    -- PROTECTED UPDATE: Don't overwrite existing name with 'Anonymous'
