-- STEP 2: FIX THE LIST
-- This script ONLY updates the "Who gets it" list.
-- It keeps the notification logic exactly the same (One-Time).
...
BEGIN
    ...
    LOOP
        ...
        FOR group_record IN 
            ...
            -- This explicitly KEEPS everything else (English, French, etc.)
        LOOP
            
            -- (Preserving existing format logic)
